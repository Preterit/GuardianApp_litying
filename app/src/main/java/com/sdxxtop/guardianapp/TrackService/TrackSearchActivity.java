...
import com.sdxxtop.guardianapp.presenter.TrackSearchPresenter;
 ...
 */
public class TrackSearchActivity extends BaseMvpActivity<TrackSearchPresenter> implements TrackSearchContract.IView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        serviceId = SpUtil.getLong(Constants.SERVICE_ID, -1);
        terminalId = SpUtil.getLong(Constants.TERMINAL_ID, -1);
        trackId = SpUtil.getLong(Constants.TRACK_ID, -1);
        ...
        findViewById(R.id.activity_track_search_search_track).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                aMapTrackClient.queryTerminal(new QueryTerminalRequest(serviceId, ""), new SimpleOnTrackListener() {
                    @Override
...
//                                long tid = queryTerminalResponse.getTid();
    ...
    protected void initData() {
        super.initData();
//        mPresenter.loadAllTrack();
    }

    @Override
    public void checkTrack(TrackInfoBean bean) {
    }
}
